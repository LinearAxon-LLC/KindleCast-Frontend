    ...
    <div data-testid="device-setup" className="max-w-2xl mx-auto">
      <div className="bg-white/80 backdrop-blur-xl border border-black/[0.08] rounded-[16px] p-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-[24px] font-bold text-[#273F4F] mb-2">Connect Your Kindle</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-[8px] p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-[15px] font-semibold text-blue-800 mb-2">Important: Whitelist Our Email</h4>
                  <p className="text-[13px] text-blue-700 mb-3">
                    Amazon only accepts documents from approved email addresses. You must add <strong>{KINDDY_SENDER_EMAIL}</strong> to your Kindle's approved sender list to receive converted content.
                  </p>
                  <div className="bg-white border border-blue-200 rounded-[6px] p-3 mb-3">
                    <p className="text-[13px] text-blue-800 font-medium mb-2">How to whitelist:</p>
                    <ol className="text-[12px] text-blue-700 space-y-1 list-decimal list-inside">
                      <li>Go to Amazon → Manage Your Content and Devices</li>
                      <li>Click "Preferences" → "Personal Document Settings"</li>
                      <li>Under "Approved Personal Document E-mail List", click "Add a new approved e-mail address"</li>
                      <li>Enter: <strong>{KINDDY_SENDER_EMAIL}</strong></li>
        ...
        <div className="flex justify-between mt-8">
          ...
          >
            {isLoading ? 'Connecting...' : step === 2 ? 'Connect Kindle' : 'Next'}
          </button>
        </div>
      </div>
    </div>
