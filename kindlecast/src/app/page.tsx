...
function FeatureImage({
  ...
  return (
    <div
      className={`w-full aspect-[4/5] rounded-2xl ${color} ${className}`}
    ></div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#EFEEEA]">
      ...
      <section className="pt-24 sm:pt-32 lg:pt-40 pb-16 sm:pb-20 lg:pb-32 bg-[#EFEEEA]">
        ...
        <KindleReaderHome></KindleReaderHome>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 max-w-3xl mx-auto">
              Transform any content into perfectly formatted Kindle reading in
              just a few clicks
            </p>
          </div>
          ...
          <div className="space-y-20 lg:space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="space-y-6">
                ...
                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                  Simply paste a webpage URL, upload a document, or add text
                  content. Our AI instantly extracts and cleans the content,
                  removing ads, sidebars, and distractions.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="space-y-6">
                ...
                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                  Every document is optimized for your Kindle device with proper
                  typography, spacing, and layout that makes reading comfortable
                  and enjoyable.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="space-y-6 lg:order-2">
                ...
                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                  Your perfectly formatted document is instantly sent to your
                  Kindle device or app. Start reading immediately with zero
                  setup required.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-600 text-[15px] sm:text-base">
                      Direct to Kindle delivery
                    </span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-brand-accent rounded-full"></div>
                    <span className="text-gray-600 text-[15px] sm:text-base">
                      Works with all Kindle devices
                    </span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-brand-accent rounded-full"></div>
