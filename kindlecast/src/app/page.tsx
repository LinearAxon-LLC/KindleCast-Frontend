      ...
      <section className="pt-28 sm:pt-32 lg:pt-40 pb-16 sm:pb-20 lg:pb-32 bg-[#EFEEEA] px-6 sm:px-8 lg:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[15px] sm:text-[17px] lg:text-xl text-center text-gray-600 leading-relaxed max-w-3xl mx-auto px-2 sm:px-4">
            Send
            <span
              className="mx-1 sm:mx-2 inline-block bg-purple-600 rounded-sm"
            ...
            ,
            <span
              className="mx-1 sm:mx-2 inline-block bg-rose-400 rounded-sm"
              style={{ transform: "skew(-10deg)" }}
            >
              <span
                className="px-1.5 sm:px-2 inline-block text-white font-semibold text-[12px] sm:text-[14px]"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                  Simply paste a webpage URL - can be an article, blogpost,
                  podcast, video, social media post/thread, or upload a PDF,
                  Docx, ReadMe or EPUB.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              <div className="space-y-6 lg:order-2">
                ...
                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                  ...
                  access your content library from your dashboard. And track
                  your usages.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
