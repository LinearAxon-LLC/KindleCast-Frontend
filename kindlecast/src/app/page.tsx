...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#EFEEEA]">
            {/* Navigation */}
            <nav
                className="fixed top-4 left-4 right-4 sm:top-6 sm:left-1/2 sm:right-auto sm:transform sm:-translate-x-1/2 z-50 bg-[#EFEEEA]/80 backdrop-blur-xl border border-black/[0.08] rounded-[12px] shadow-[0_1px_3px_rgba(0,0,0,0.05),0_20px_25px_rgba(0,0,0,0.04)]">
                <div
                    className="px-4 py-3 sm:px-6 sm:py-4 lg:px-8 flex items-center justify-between w-full sm:w-[900px] sm:max-w-[calc(100vw-48px)]">
                    <div className="flex items-center space-x-3 lg:space-x-0">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-3">
                            <div
                                className="w-7 h-7 sm:w-8 sm:h-8 bg-brand-primary rounded-[8px] flex items-center justify-center">
                                <svg
                                    width="16"
                                    height="16"
                                    viewBox="0 0 14 14"
            ...
            >
                <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                                    Your reading list is everywhere. Effortlessly capture articles from news sites,
                                    posts from social media, chapters from PDFs, and even transcripts from videos. If
                                    you can link to it or upload it, you can read it on your Kindle.
                                </p>
                    ...
                    Powered by AI
                                ...
                                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                                    Our AI acts as your digital de-clutter. It intelligently strips away ads, pop-ups,
                                    and website clutter, leaving you with nothing but the clean, beautifully formatted
                                    text. It’s the serene reading experience you've been missing.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-center space-x-3">
                      ...
                      Custom instructions
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                            <div className="space-y-6">
                                ...
                                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                                    Never lose a valuable article again. Every piece of content you convert is
                                    automatically saved to your personal library. Re-read your favorites, discover new
                                    connections, and build a powerful, searchable archive of the ideas that matter to
                                    you.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-center space-x-3">
                      ...
                      Resend to Kindle or Download
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                            <div className="space-y-6 lg:order-2">
                                ...
                                <p className="text-[16px] sm:text-[18px] lg:text-xl text-gray-600 leading-relaxed">
                                    Set your Kindle email once and you're done. Our "send-it-and-forget-it" system works
                                    quietly in the background, delivering perfectly formatted articles directly to your
                                    device. It feels like magic.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-center space-x-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Just paste any link or upload a document, and Kinddy instantly cleans up the
                                content—removing ads, pop-ups, and clutter—then reformats it into a seamless,
                                Kindle-friendly reading experience.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                <b>Quick Send</b> gives you a clean, distraction-free EPUB in seconds.
                                <b>AI Formatting</b> takes it further—using advanced AI to summarize, restructure, or
                                even turn the content into a study guide or cheat sheet.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
                            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">
                                How does <span
                                className="bg-gradient-to-r from-violet-500 via-fuchsia-500 to-red-500 bg-clip-text text-transparent">AI Content Transformation</span> make
                                reading better?
                            </h3>
                            <p className="text-gray-600 text-sm sm:text-base">
                                With one click, you can <b
                                className="bg-gradient-to-r from-violet-500 via-fuchsia-500 to-red-500 bg-clip-text text-transparent uppercase">Summarize</b>,
                                create an <b
                                className="bg-gradient-to-r from-violet-500 via-fuchsia-500 to-red-500 bg-clip-text text-transparent uppercase">AI
                                Study Guide</b>, or provide your own <b
                                className="bg-gradient-to-r from-violet-500 via-fuchsia-500 to-red-500 bg-clip-text text-transparent uppercase">Custom
                                Instructions</b>.
                                This means less fluff, more focus—so you absorb key insights faster.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Articles, blog posts, newsletters, social threads, research papers, and even YouTube
                                videos (we grab the transcript for you).
                                If it’s text-based, Kinddy can likely send it to your Kindle—clean and ready to read.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Yep! Kinddy is optimized for every Kindle model, including Paperwhite, Oasis, Scribe,
                                and even the basic Kindle.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Absolutely. Every user starts with <b><u>5 free Quick Sends and 3 AI Formattings each
                                month</u></b>—no credit card needed.
                                Test it out, see the quality, and upgrade only if you love it.
                            </p>
                        </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="space-y-8">
                        ...
                        <p className="text-[18px] sm:text-[20px] lg:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                            Reclaim your focus and give your eyes the break they deserve. Send your first article in the
                            next 60 seconds. The experience will change the way you read online, forever.
                        </p>
