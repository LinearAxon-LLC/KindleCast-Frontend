    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 bg-white/80 backdrop-blur-xl border border-black/[0.08] rounded-[12px] shadow-[0_1px_3px_rgba(0,0,0,0.05),0_20px_25px_rgba(0,0,0,0.04)]">
        <div className="px-8 py-4 flex items-center justify-between min-w-[720px]">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-[8px] flex items-center justify-center">
          ...
          <div className="flex items-center space-x-8">
            <a href="#pricing" className="text-black/60 hover:text-black/85 font-medium cursor-pointer text-[13px] transition-colors duration-200">Pricing</a>
            <a href="#faq" className="text-black/60 hover:text-black/85 font-medium cursor-pointer text-[13px] transition-colors duration-200">FAQ</a>
            <button className="bg-brand-primary hover:bg-brand-primary/90 active:bg-brand-primary/80 text-white text-[13px] font-medium py-2 px-4 rounded-[8px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] transition-all duration-150 active:scale-[0.98] cursor-pointer">
              Get Started
            </button>
          </div>
        </div>
      ...
      <section className="pt-40 pb-32 px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[17px] text-black/60 leading-[24px] mb-12 max-w-xl mx-auto">
            Transform any web content into comfortable Kindle reading.
          </p>

          {/* macOS Native Input Box */}
          <div className="max-w-2xl mx-auto mb-8">
            <div className="bg-white/80 backdrop-blur-xl border border-black/[0.08] rounded-[12px] shadow-[0_1px_3px_rgba(0,0,0,0.05),0_20px_25px_rgba(0,0,0,0.04)] p-8">
              <div className="space-y-6">
                ...
                {/* Format Selection */}
                <div>
                  <label className="text-[13px] font-medium text-black/60 uppercase tracking-[0.4px] mb-3 block text-center">
                    Choose your format:
                  </label>
                ...
                {/* Primary Action */}
                <button className="w-full bg-brand-primary hover:bg-brand-primary/90 active:bg-brand-primary/80 text-white text-[13px] font-medium py-3 px-6 rounded-[8px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] transition-all duration-150 active:scale-[0.98] cursor-pointer flex items-center justify-center">
      ...
      <section id="pricing" className="py-32 px-8 bg-black/[0.02]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="bg-gradient-to-br from-brand-primary to-brand-secondary rounded-3xl p-8 text-white relative">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                Simply paste any URL or upload a document, and our AI will extract the content, remove distractions like ads and sidebars, and format it perfectly for Kindle reading.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                KindleCast works with web articles, blog posts, newsletters, social media threads, research papers, and most text-based documents.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                Yes! Our formatting is optimized for all Kindle devices, including Kindle Paperwhite, Kindle Oasis, Kindle Scribe, and the basic Kindle.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                Absolutely! You get 3 free conversions with no credit card required. This lets you test the quality before deciding to upgrade.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                Kindle&apos;s e-ink display eliminates blue light emission and screen glare, which are the primary causes of digital eye strain.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="py-16 px-8 bg-black/[0.02] text-black/85">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-black/[0.08] pt-8 flex flex-col md:flex-row justify-between items-center">
